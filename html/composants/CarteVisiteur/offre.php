...
class OffreHandler
{
    ...
    private function displayOffre($offre)
    {
        ...
        if (!defined('OFFRE_CSS_LOADED')) {
            define('OFFRE_CSS_LOADED', true);
            echo '<link rel="stylesheet" href="/composants/CarteVisiteur/offre.css">';
        }
        ...
        if ($typeOffre === 'parc_d_attractions') {
            ...
            Label::render(
                ...
                '',
                '',
                ucfirst(htmlspecialchars($offre['titre'])),
        ...
        for ($i = 0; $i < 5; $i++) {
            if ($i < floor($offre['moynotes'])) {
            echo '<img src="../../../ressources/etoile_pleine.svg" alt="etoile pleine">';
            } elseif ($i < ceil($offre['moynotes'])) {
            echo '<img src="../../../ressources/etoile_demi.svg" alt="etoile demi">';
            } else {
            echo '<img src="../../../ressources/etoile_vide.svg" alt="etoile vide">';
            }
        }
        echo '</div>';
