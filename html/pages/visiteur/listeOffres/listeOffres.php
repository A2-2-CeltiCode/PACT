...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest') {
    ...
    foreach ($resultats as $item) {
        $offre = new Offre(nom: $item['titre'], typeO: $item['nomcategorie'], ville: "o", imageO: $item['nomimage'], nomProprietaire: "o", idoffre: $item['idoffre'], duree: $item['tempsenminutes'], note: 2, option:"ee");
        $offres[] = (string)$offre;
    }
