function rechercher() {
  ...
  const localisationInput = document.querySelector(
  ...
  const ouvertureInput = document.querySelector(
    'input[name="ouverture"]'
  ).value;
  const fermetureInput = document.querySelector(
  ...
  const inputNote = document.querySelector(
  ...
  if (categoryInputs.length > 0)
    params.append("nomcategorie", categoryInputs.join(","));
