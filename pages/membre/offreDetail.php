...
<body>
    ...
    <main>
        <div class="offre">
            ...
            <img class="image-offre" alt="Image offre" src="assets/cate.jpg" />

            <div class="description">
                <h2>
                    <!-- Icône de restaurant avec texte de titre -->
                    <img src="assets/icon/restaurant.svg" alt="Logo restaurant" style="vertical-align: middle; height: 40px;">
                    Saveur de Bretagne
                </h2>
                ...
                <h3>
                    ...
                    <img src="assets/icon/horloge.svg" alt="Logo horloge" style="vertical-align: middle; height: 40px;">
                    11h-15h & 19h-23h
                </h3>

                <h3>
                    <!-- Icône de navigation et lien vers le site web -->
                    <img src="assets/icon/naviguer.svg" alt="Logo site web" style="vertical-align: middle; height: 40px;">
                ...
                <h3>
                    ...
                    <img src="assets/icon/localisateur.svg" alt="Logo position" style="vertical-align: middle; height: 40px;">
            ...
            <div class="colonne-droite">
                <div class="note_etoiles">
                    ...
                    <img src="assets/icon/etoile_pleine.svg" alt="Logo étoile pleine" style="vertical-align: middle;">
                    <img src="assets/icon/etoile_pleine.svg" alt="Logo étoile pleine" style="vertical-align: middle;">
                    <img src="assets/icon/etoile_pleine.svg" alt="Logo étoile pleine" style="vertical-align: middle;">
                    <img src="assets/icon/etoile_mid.svg" alt="Logo étoile pleine" style="vertical-align: middle;">
                    <img src="assets/icon/etoile_vide.svg" alt="Logo étoile pleine" style="vertical-align: middle;">
                ...
                <div class="carte">
                    ...
                    <!-- Informations de profil : photo, nom, localisation, contact -->
                        ...
                        <div>
                            <h2>Serge Sauvion</h2>
                            <p>
                                <img src="assets/icon/localisateur.svg" alt="Icon localisation" style="vertical-align: middle;">
                                Lannion
                            </p>
                        </div>
                    </div> 
                    ...
                    <div class="dessous-carte">
                        <div class="email">
                            <img src="assets/icon/lettre.svg" alt="Icon lettre" style="vertical-align: middle;">
                            <a href="mailto:serge@gmail.com">serge@gmail.com</a>
                        </div>
                        <div class="telephone">
                            <img src="assets/icon/telephone.svg" alt="Icon téléphone" style="vertical-align: middle;">
    ...
    <footer>
        ...
        <div class="icones-reseaux-sociaux">
            ...
            <a href="https://www.facebook.com/?locale=fr_FR"><img src="assets/icon/facebook.svg" alt="Icon facebook" style="vertical-align: middle;"></a>
            <a href="https://x.com/TripEnArvorPACT"><img src="assets/icon/twitter.svg" alt="Icon X" style="vertical-align: middle;"></a>
            <a href="https://www.instagram.com/pactlannion/"><img src="assets/icon/instagram.svg" alt="Icon instagram" style="vertical-align: middle;"></a>
        </div>
        <p>© 2024 PACT, Inc.</p>
        <a href="#entete" class="remonter-page"><img src="assets/icon/fleche.svg" alt="Icon fleche" style="vertical-align: middle;"></a>
    </footer>
</body>
</html>